...
public class  MsgEquationServer{
 
  public static void main(String[] args){
    MsgEquationServer server=new MsgEquationServer();
    server.service();
  }
  ...
  private void service(){
    try{
      ...
      Topic t=new com.sun.messaging.Topic("Equation"); 
      JMSContext ctx=cf.createContext();
      JMSConsumer consumer = ctx.createSharedConsumer(t,"Equation");
  ...
  private String equation(long num){
