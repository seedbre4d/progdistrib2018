...
public class EquationListener implements ReadListener, WriteListener{
    ...
    public EquationListener(ServletInputStream in, AsyncContext ac, ServletOutputStream output) throws IOException{
        input = in;
        context = ac;
        out = output;
